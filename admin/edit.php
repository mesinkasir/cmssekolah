...
<div class="container">
	...
	<!-- pill edit navigation -->
		<div class="edit-nav" >
			...
			?>
			<!--<a href="#" id="metadata_toggle" accesskey="<?php echo find_accesskey(i18n_r('PAGE_OPTIONS'));?>" >Title</a>-->
...
<!--			<span class="editing"><?php echo i18n_r('EDITPAGE_TITLE') .': ' . $title; ?></span> -->
			<div id="submit_line" >
				...
				<span><input id="page_submit" class="submit  mdl-button mdl-js-button mdl-button--raised mdl-button--colored bg-danger text-white" type="submit" name="submitted" value="<?php echo $buttonname; ?>" /></span>
				
				<div class="float-right">
					<!-- <h6 class="dropdownaction"><?php i18n('ADDITIONAL_ACTIONS'); ?></h6> -->
					<a href="#" ><?php i18n('SAVE_AND_CLOSE'); ?></a>
						/ <?php if($url != '') { ?>
							<a href="pages.php?id=<?php echo $url; ?>&amp;action=clone&amp;nonce=<?php echo get_nonce("clone","pages.php"); ?>" ><?php i18n('CLONE'); ?></a>
						<?php } ?>
					/ 	<a href="pages.php?cancel" ><?php i18n('CANCEL'); ?></a>
						<?php if($url != 'index' && $url != '') { ?>
					/ 	<a href="deletefile.php?id=<?php echo $url; ?>&amp;nonce=<?php echo get_nonce("delete","deletefile.php"); ?>" ><?php echo strip_tags(i18n_r('ASK_DELETE')); ?></a>
						<?php } ?>
				</div>
